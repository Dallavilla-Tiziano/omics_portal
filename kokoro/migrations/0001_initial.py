# Generated by Django 5.1.6 on 2025-06-06 10:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(blank=True, choices=[('CD', 'Cardiac Device'), ('LR', 'Loop Recorder'), ('PM', 'Pace Maker')], default='', max_length=5)),
                ('company', models.CharField(blank=True, choices=[('AB', 'Abbott'), ('BT', 'Biotronik'), ('MT', 'Medtronic'), ('BS', 'Boston'), ('SJ', 'St. Jude')], default='', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cardioref_id', models.PositiveIntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='device_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='device', to='kokoro.devicetype'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='deviceinstance',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patient', to='kokoro.patientprofile'),
        ),
        migrations.CreateModel(
            name='DeviceImplant',
            fields=[
                ...
                ('device_instance', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='implant', to='kokoro.deviceinstance')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kokoro.patientprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Omics Analyses',
            },
        ),
        migrations.AddField(
